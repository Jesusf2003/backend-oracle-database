...
(
    ...
    CONSTRAINT chk_nombre_persona CHECK (REGEXP_LIKE(nombres, '^[A-Za-z������������[:space:]-]+$')),
    CONSTRAINT chk_apellidos CHECK (REGEXP_LIKE(apellidos, '^[A-Za-z������������[:space:]-]+$')),
...
-- Crear tabla Inscripci�n desde el usuario developer_01
...
(
    ...
    CONSTRAINT chk_nombre_carrera CHECK (REGEXP_LIKE(nombre, '^[A-Za-z������������ .\-]+$'))
);
...
-- Desde Developer_02 relacionar tabla inscripci�n con pago
...
-- <> DATASOFT -> carrera
-- INSERCI�N de registros en la tabla Carrera del usuario Datasoft
...
VALUES ('ASE', 'An�lisis de Sistemas Empresariales', 'Profesionales innovadores en tecnolog�a')
INTO datasoft.carrera (identificador, nombre, descripcion)
VALUES ('GAG', 'Gesti�n Agr�cola', 'Profesionales para innovar la agricultura')
INTO datasoft.carrera (identificador, nombre, descripcion)
VALUES ('ADS', 'An�lisis de Sistemas', 'Formamos programadores de software')
INTO datasoft.carrera (identificador, nombre, descripcion)
VALUES ('PAG', 'Producci�n Agraria', 'Formamos profesionales de la agricultura')
SELECT * FROM dual;
COMMIT;
...
-- <> DATASOFT -> ciclo
-- INSERCI�N de registros en la tabla ciclo del usuario Datasoft
-- VERIFICAR la estructura de la tabla ciclo del usuario Datasoft
DESC datasoft.ciclo;
-- --- Desde el usuario DATASOFT crear la tabla ciclo
-- La inserci�n debe ser individual ya que hay un campo auto incrementable
ALTER SESSION SET NLS_DATE_FORMAT = 'DD/MM/YYYY HH24:MI:SS';
...
-- INSERCI�N de registros en la tabla persona del usuario developer_01
...
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Camila', 'Villa Or�', TO_DATE('20/05/2005', 'DD/MM/YYYY'), 'DNI', '15451236', 'camila@gmail.com', 921526621, 'camilavilla', 'CaMiAAORE20', 'EST' );
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
...
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Abel', 'V�squez Iriarte', TO_DATE('25/11/2004', 'DD/MM/YYYY'), 'CNE', '15744514136941369741', 'abelvasquez@outlook.com', 952388179, 'abelvasquez', '18Abel123', 'EST' );
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
...
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Carolina', 'V�squez Iriarte', TO_DATE('25/11/2004', 'DD/MM/YYYY'), 'CNE', '15744514136941369741', 'abelvasquez@outlook.com', 952388179, 'abelvasquez', 'Abel23vasQ', 'EST' );
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Luc�a', 'Mart�nez �lvarez', TO_DATE('12/05/2004', 'DD/MM/YYYY'), 'DNI', '20451238', 'lucia.martinez@gmail.com', 921537821, 'luciamartinez', 'Lucia123', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Juan', 'P�rez L�pez', TO_DATE('25/09/2005', 'DD/MM/YYYY'), 'DNI', '20451239', 'juan.perez@gmail.com', 922562134, 'juanperez', 'JuanPerez12', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Ana', 'Garc�a S�nchez', TO_DATE('11/07/2003', 'DD/MM/YYYY'), 'CNE', '12345678901234567890', 'ana.garcia@outlook.com', 925478123, 'anagarcia', 'AnaG156GR', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Carlos', 'Rodr�guez Fern�ndez', TO_DATE('10/02/2004', 'DD/MM/YYYY'), 'DNI', '20451240', 'carlos.rodriguez@yahoo.com', 926583921, 'carlosrodriguez', 'Carlos12345', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Mar�a', 'L�pez G�mez', TO_DATE('20/12/2004', 'DD/MM/YYYY'), 'CNE', '12345678901234567891', 'maria.lopez@gmail.com', 927492134, 'marialopez', 'MarLopez12', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Sof�a', 'M�ndez Paredes', TO_DATE('16/08/2005', 'DD/MM/YYYY'), 'DNI', '20451241', 'sofia.mendez@gmail.com', 928593847, 'sofiamendez', 'SofiaMen12', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Diego', 'Vega Hern�ndez', TO_DATE('04/10/2004', 'DD/MM/YYYY'), 'CNE', '12345678901234567892', 'diego.vega@outlook.com', 929637182, 'diegovega', 'Diego12VG', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Laura', 'Ruiz Mart�nez', TO_DATE('29/03/2003', 'DD/MM/YYYY'), 'DNI', '20451242', 'laura.ruiz@gmail.com', 930751289, 'lauraruiz', 'LauraRM123', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Pablo', 'Ramos D�az', TO_DATE('02/06/2004', 'DD/MM/YYYY'), 'DNI', '20451243', 'pablo.ramos@gmail.com', 931863794, 'pabloramos', 'Pabl0Ramos1', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Claudia', 'Hern�ndez Torres', TO_DATE('09/11/2005', 'DD/MM/YYYY'), 'CNE', '12345678901234567893', 'claudia.hernandez@outlook.com', 932975817, 'claudiahernandez', 'ClaudHern1', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
...
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Elena', 'Ortiz Guti�rrez', TO_DATE('13/03/2004', 'DD/MM/YYYY'), 'CNE', '12345678901234567894', 'elena.ortiz@outlook.com', 934291874, 'elenaortiz', 'ElenaOrtiZ9', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
...
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Pedro', 'Flores Ram�rez', TO_DATE('14/04/2004', 'DD/MM/YYYY'), 'CNE', '12345678901234567895', 'pedro.flores@outlook.com', 937538719, 'pedroflores', 'PedroFlor79', 'EST');
COMMIT;
INSERT INTO DEVELOPER_01.persona
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
...
(nombres, apellidos, fecha_nacimiento, tipo_documento, numero_documento, correo_electronico, celular, usuario, contrasena, rol)
VALUES
    ('Ra�l', 'Lara Jim�nez', TO_DATE('11/12/2003', 'DD/MM/YYYY'), 'DNI', '20451248', 'raul.lara@gmail.com', 939762518, 'raullara', 'RaulLara12', 'EST');
COMMIT;
-- LISTAR registros de la tabla persona
SELECT * FROM developer_01.persona;

-- <> DEVELOPER_01 -> inscripcion
-- INSERCI�N de registros en la tabla inscripcion del usuario developer_01
...
-- INSERCI�N de registros en la tabla pago del usuario developer_02
